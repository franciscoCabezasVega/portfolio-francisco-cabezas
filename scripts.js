...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fields.forEach(field => {
    ...
    input.addEventListener('input', function (e) {
      ...
      let hasError = false;
      if (field === 'email') {
        if (trimmedLength > 0 && !/^[a-z0-9.\-_]+@[a-z0-9.\-_]+\.[a-z]{2,}$/i.test(input.value.trim())) {
          hasError = true;
    ...
    input.addEventListener('blur', function () {
      ...
      let hasError = false;
      if (field === 'email') {
        if (value.length > 0 && !/^[a-z0-9.\-_]+@[a-z0-9.\-_]+\.[a-z]{2,}$/i.test(value)) {
          hasError = true;
  ...
  function validateFormRealtime() {
    ...
    fields.forEach(field => {
      ...
      if (
        ...
        (field === 'email' && !/^[a-z0-9.\-_]+@[a-z0-9.\-_]+\.[a-z]{2,}$/i.test(value))
      ) {
        allValid = false;
      }
    });
  ...
  e.preventDefault();
  emailjs.sendForm('service_0pxmsh7', 'template_y5l3mx4', this)
    .then(function() {
